NOTICE: This fork is based on the original and simply adds the ability for the xlat to get readings from the Pulsar X2F.

If you just want the most up to date base firmware, please go to the author's page: https://github.com/teamfinalmouse/xlat
